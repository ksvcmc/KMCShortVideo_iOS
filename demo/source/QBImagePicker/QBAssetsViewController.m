...
- (IBAction)done:(id)sender
{
    ...
    if ([self.imagePickerController.delegate respondsToSelector:@selector(qb_imagePickerController:didFinishPickingAssets:sourceAssets:)]) {
        [self.imagePickerController.delegate qb_imagePickerController:self.imagePickerController
                                               didFinishPickingAssets:photos sourceAssets:self.imagePickerController.selectedAssets.array];
    }
}
    ...
    if (imagePickerController.allowsMultipleSelection) {
        ...
        [self.imageManager requestImageForAsset:asset
                               ...
                               contentMode:PHImageContentModeAspectFill
                                   options:nil
                             resultHandler:^(UIImage *result, NSDictionary *info) {
                                 if ([imagePickerController.delegate respondsToSelector:@selector(qb_imagePickerController:didFinishPickingAssets:sourceAssets:)]) {
                                     [imagePickerController.delegate qb_imagePickerController:imagePickerController didFinishPickingAssets:@[result] sourceAssets:@[asset]];
                                 }
                             }];
